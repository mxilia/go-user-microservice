...
func (u *UserService) FindAllUsers(ctx context.Context, page int, limit int) ([]*entity.User, int64, error) {
	if page < 1 || limit < 1 {
...
func (u *UserService) FindUserByEmail(ctx context.Context, email string) (*entity.User, error) {
	if email == "" {
		return nil, appError.ErrInvalidInput
	}
...
func (u *UserService) FindUserByHandler(ctx context.Context, handler string) (*entity.User, error) {
	if handler == "" {
		return nil, appError.ErrInvalidInput
	}
...
func (u *UserService) FindUserById(ctx context.Context, id uuid.UUID) (*entity.User, error) {
	if id == uuid.Nil {
		return nil, appError.ErrInvalidInput
	}
...
func (u *UserService) PatchUser(ctx context.Context, id uuid.UUID, user *entity.User) error {
